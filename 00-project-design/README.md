...
The shared AI foundation is complete. Future infrastructure is intentionally **scenario-specific and just-in-time**. [`scenario-infrastructure-roadmap.md`](scenario-infrastructure-roadmap.md) records what still needs to be built for Scenarios 02–04 without pretending those resources already exist. [`scenario-documentation-standard.md`](scenario-documentation-standard.md) gives all four scenario repositories the same reproducible SOC workflow.
